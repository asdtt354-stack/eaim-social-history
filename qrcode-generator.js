// EAIM: 저장소 안 QR 라이브러리 (qrcode-generator 2.0.4, MIT, Kazuhiko Arase).
// eaim-classroom-core.js 가 QR을 화면에서 직접 그릴 때 씁니다(외부 QR 서비스 사용 금지, 공통규칙 3번).
// 교실 모듈을 다른 저장소로 복사할 때 이 파일도 같은 폴더에 함께 복사하세요.
